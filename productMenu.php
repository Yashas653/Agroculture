		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="wheat" style="color: black;">wheat</option>
										<option value="rice" style="color: black;">rice</option>
										<option value="cotton" style="color: black;">cotton</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
				...
				<?php
				    ...
				    if(isset($_GET['type']) AND $_GET['type'] == "wheat")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'wheat'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "rice")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'rice'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "cotton")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'cotton'";
					}
