					...
					<form method="post" action="#">
						<div class="row uniform 50%">
							...
							<div class="4u 12u$(small)">
										...
										<label for="priority-low"><h2 style="font-size: 120%;">wheat</h2></label>
									</div>
									<div class="4u 12u$(small)">
										<input type="radio" id="priority-normal" name="priority">
										<label for="priority-normal"><h2 style="font-size: 120%;">rice</h2></label>
									</div>
									<div class="4u$ 12u$(small)">
										<input type="radio" id="priority-high" name="priority">
										<label for="priority-high"><h2 style="font-size: 120%;"> cotton</h2></label>
									</div>
